  ...
  return (
    <main style={{
      ...
      <svg
        ...
        fill="none"
      >
        <path d="M 350 0 C 200 150 50 300 100 600" stroke="var(--hairline-strong)" strokeWidth="1.5" fill="none" />
        <path d="M 400 100 C 250 250 100 400 150 600" stroke="var(--hairline-strong)" strokeWidth="1" fill="none" opacity="0.5" />
      </svg>
      <svg
        ...
        fill="none"
      >
        <path d="M 0 0 C 150 100 300 200 400 350" stroke="var(--hairline-strong)" strokeWidth="1.5" fill="none" />
      </svg>
      ...
      <div style={{
          ...
          <div className="form-group" style={{ marginBottom: 0 }}>
            ...
            <div style={{ position: "relative" }}>
              <input
                ...
                required
                style={{ padding: "0.75rem 3rem 0.75rem 0" }}
              />
              <button
                type="button"
        ...
        <div style={{ margin: "2rem 0", position: "relative", textAlign: "center" }}>
          <div style={{ position: "absolute", top: "50%", left: 0, right: 0, borderTop: "1px solid var(--hairline-strong)" }}></div>
          <span style={{
            background: "var(--surface-card)",
            position: "relative",
            padding: "0 1rem",
