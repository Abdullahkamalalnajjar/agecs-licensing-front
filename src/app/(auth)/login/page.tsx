...
export default function LoginPage() {
  ...
  const triggerGoogleLogin = () => {
    const btn = googleButtonRef.current?.querySelector("div[role='button'], iframe") as HTMLElement | null;
    if (btn) btn.click();
    else {
      // fallback: click any child element
      const anyBtn = googleButtonRef.current?.querySelector("*") as HTMLElement | null;
    ...
    <main style={{
      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: "400px" }}>
          ...
          {/* Hidden Google button – triggers real Google popup */}
          <div
            ref={googleButtonRef}
